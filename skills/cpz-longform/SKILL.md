---
name: cpz-longform
description: CPZ Fitness long-form content writing. Use for blog posts, newsletters, and LinkedIn articles. Extends cpz-fitness root — load cpz-fitness first.
---

# CPZ Fitness — Long-Form Content Skill

> Builds on **cpz-fitness** for brand DNA, voice, ICA, and colors. Load cpz-fitness first. For Skool classroom lessons, use the **cpz-skool** skill instead — that's a Skool-platform format, not a long-form-content format.
...
5. Avoid hype language, excessive emojis, and motivational filler (see `cpz-fitness/SKILL.md` vocabulary guide)
