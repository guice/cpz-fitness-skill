...
**SEO note:** Write for the ICA first, algorithm second. If there's a natural keyword (e.g., "fitness for software engineers"), use it in the headline and once or twice in the body — but never at the expense of voice.

**Arc:**
1. **Hook** — Names the specific wrong belief or relatable failure. Philip's version of the mistake comes first. (100–150 words)
2. **Diagnosis** — Why this happens in analytical terms. Systems framing. No judgment. (200–300 words)
...
- `[The thing they're doing wrong]: [why it matters]` — "Skipping the gym isn't laziness: it's a systems bug"
...
2. **Data or insight** — The analytical layer. A stat, a reframe, a connection the ICA hasn't made. (150–200 words)
...
2. **The diagnosis** — Why the problem exists in analytical terms. 1–2 paragraphs.
...
### Course 3 Lesson Format — Deployment Blueprint

All Course 3 lessons follow additional standards:
...
- `**Dig a little deeper:**` — analytical
- `**Take Action:**` — execution

**Key Takeaway:** Final element of every lesson. Bolded. Written in Deployment Blueprint vocabulary (Kubernetes/Terraform/deployment metaphors matching the lesson's master metaphor).
